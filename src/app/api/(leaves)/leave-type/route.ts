...
export const POST = async (req: NextRequest) => {
    try {
        ...
        if (auth_data.membership.role !== "admin" && auth_data.membership.role !== "hr") {
            console.error("Only Admin and hr can access:");
        ...
        const { org_id, Leave_Type_Name, Leave_Type_Description, carryforward, count } = await req.json();
